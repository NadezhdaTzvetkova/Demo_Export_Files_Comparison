...
class ObjectStringArrayMixin(BaseStringArrayMethods):
    ...
    def _str_contains(
        ...
        if regex:
            ...
            if case:
                ...
                def f(x):
                    return upper_pat in x.upper()

        return self._str_map(f, na, dtype=np.dtype("bool"))

    def _str_startswith(self, pat, na=None):
        def f(x):
            return x.startswith(pat)
    ...
    def _str_replace(
        ...
        if regex or flags or callable(repl):
            ...
            def f(x):
                return pat.sub(repl=repl, string=x, count=n)
    ...
    def _str_fullmatch(
        ...
        def f(x):
            return regex.fullmatch(x) is not None

        return self._str_map(f, na_value=na, dtype=np.dtype(bool))

    def _str_encode(self, encoding, errors: str = "strict"):
        def f(x):
            return x.encode(encoding, errors=errors)
    ...
    def _str_find_(self, sub, start, end, side):
        ...
        if end is None:
            ...
            def f(x):
                return getattr(x, method)(sub, start)

        else:

            def f(x):
                return getattr(x, method)(sub, start, end)
    ...
    def _str_split(
        ...
        if pat is None:
            ...
            if isinstance(new_pat, re.Pattern):
                ...
                def f(x):
                    return new_pat.split(x, maxsplit=n)
    ...
    def _str_normalize(self, form):
        def f(x):
            return unicodedata.normalize(form, x)
