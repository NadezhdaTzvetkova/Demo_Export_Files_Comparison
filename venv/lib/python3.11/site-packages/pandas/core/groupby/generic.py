...
class SeriesGroupBy(GroupBy[Series]):
    ...
    def filter(self, func, dropna: bool = True, *args, **kwargs):
        ...
        if isinstance(func, str):
            ...
            def wrapper(x):
                return getattr(x, func)(*args, **kwargs)
    ...
    def value_counts(
        ...
        if bins is None:
            ...
            def llab(lab, inc):
                return lab[inc]._multiindex.codes[-1]
...
class DataFrameGroupBy(GroupBy[DataFrame]):
    ...
    def _define_paths(self, func, *args, **kwargs):
        if isinstance(func, str):
            ...
            def fast_path(group):
                return getattr(group, func)(*args, **kwargs)
            ...
            def slow_path(group):
                return group.apply(lambda x: func(x, *args, **kwargs), axis=self.axis)
