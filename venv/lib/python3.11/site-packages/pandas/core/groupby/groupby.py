    ...
    **Attributes**
    ...
    def rank(
        ...
        if axis != 0:
            ...
            def f(x):
                return x.rank(axis=axis, numeric_only=False, **kwargs)
    ...
    def cumprod(
        ...
        if axis != 0:
            ...
            def f(x):
                return x.cumprod(axis=axis, **kwargs)
    ...
    def cumsum(
        ...
        if axis != 0:
            ...
            def f(x):
                return x.cumsum(axis=axis, **kwargs)
    ...
    def cummin(
        ...
        **kwargs,
        ...
        if axis != 0:
            ...
            def f(x):
                return np.minimum.accumulate(x, axis)
    ...
    def cummax(
        ...
        **kwargs,
        ...
        if axis != 0:
            ...
            def f(x):
                return np.maximum.accumulate(x, axis)
    ...
    def shift(
        ...
        for period in periods:
            ...
            if freq is not None or axis != 0:
                ...
                def f(x):
                    return x.shift(period, freq, axis, fill_value)
