...
class TestStyler:
    ...
    def test_render(self):
        ...
        def style(x):
            return Series(["color: red", "color: blue"], name=x.name)
    ...
    def test_apply_series_return(self, axis):
        ...
        def func(s):
            return Series(["color: red;"], index=["Y"])
        ...
        def func(s):
            return Series(["color: red;", "color: blue;"], index=["Y", "X"])
    ...
    def test_export(self, df, styler):
        def f(x):
            return "color: red" if x > 0 else "color: blue"

        def g(x, z):
            return f"color: {z}" if x > 0 else f"color: {z}"
