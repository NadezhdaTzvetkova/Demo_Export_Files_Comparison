...
HardwareModules.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "hwSerialEntries", univ.SequenceOf(componentType=HardwareSerialEntry())
    ),
)
...
FirmwarePackageInfo.sizeSpec = univ.Sequence.sizeSpec + constraint.ValueSizeConstraint(
    1, 2
)
...
FirmwarePackageLoadError.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "config",
        univ.SequenceOf(componentType=CurrentFWConfig()).subtype(
