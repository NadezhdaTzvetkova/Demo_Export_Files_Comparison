...
HardwareModules.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "hwSerialEntries",
        univ.SequenceOf(componentType=HardwareSerialEntry()).subtype(
...
TargetIdentifier.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "hwModules",
        HardwareModuleIdentifierList().subtype(
...
StatusResponse.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "terseResponse",
        TerseStatusResponse().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0)
        ),
    ),
    namedtype.NamedType(
        "verboseResponse",
        VerboseStatusResponse().subtype(
...
TrustAnchorChangeInfoChoice.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "tbsCertChange",
        TBSCertificateChangeInfo().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0)
        ),
    ),
    namedtype.NamedType(
        "taChange",
        TrustAnchorChangeInfo().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1)
        ),
    ),
)
...
TrustAnchorUpdate.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "change",
        TrustAnchorChangeInfoChoice().subtype(
...
UpdateConfirm.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "terseConfirm",
        TerseUpdateConfirm().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)
        ),
    ),
    namedtype.NamedType(
        "verboseConfirm",
        VerboseUpdateConfirm().subtype(
            implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1)
        ),
    ),
)
