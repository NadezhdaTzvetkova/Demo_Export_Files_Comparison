...
def before_all(context):
    ...
    try:
        ...
        bhx_benv._log_exception_and_continue(
            "before_all (behavex-images)", exception=ex
        )
...
def before_scenario(context, scenario):
    ...
    try:
        ...
        context.bhximgs_step_log_handler = logging.StreamHandler(
            context.bhximgs_log_stream
        )
...
def after_scenario(context, scenario):
    ...
    try:
        if "bhximgs_attachments_condition" in context and (
            ...
            or (
                context.bhximgs_attachments_condition
                == AttachmentsCondition.ONLY_ON_FAILURE
