...
def export_result_to_html(
    ...
    execution_start_time = time.strftime(
        "%Y-%m-%d %H:%M:%S", time.localtime(global_vars.execution_start_time)
    )
    execution_end_time = time.strftime(
        "%Y-%m-%d %H:%M:%S", time.localtime(global_vars.execution_end_time)
    )
    parameters_template = {
        "features": features,
        "steps": steps_summary,
        ...
        "execution_times": {
            ...
            "total_execution_time": global_vars.execution_end_time
            - global_vars.execution_start_time,
        },
    }
